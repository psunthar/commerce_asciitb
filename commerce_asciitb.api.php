...
/**
 * @file
 * Documents hooks provided by the ASC-IITB modules.
 */
 ...
 *
 * When the ASC-IITB module receives an Instant Payment Notification (IPN) from
 * ASC-IITB, it performs some basic validation, allows the payment method detected
 ...
 * parent_txn_id and auth_id values. See the ASC-IITB OP IPN process callback for
...
/**
 * Allows modules to alter the name-value pair array for a ASC-IITB API request
 * before it is submitted.
 *
 * Currently invoked for ASC-IITB Payments Pro and Express Checkout. Modules
 ...
 */
function hook_commerce_asciitb_api_request_alter(&$nvp, $order, $payment_method) {
  // No example.
}
